package com.javadiseno.sanosysalvos.media.services;
...
import com.javadiseno.sanosysalvos.media.dtos.MediaUploadResponse; // JSON devuelto tras subir
import com.javadiseno.sanosysalvos.media.dtos.PresignPutRequest; // body del presign PUT
import com.javadiseno.sanosysalvos.media.dtos.PresignPutResponse; // JSON con URL PUT firmada
